...
def visualize_images(trainset, classes):
...
@torch.no_grad()
def visualize_attention_mnist(model, output=None, device="cuda"):
    """
    Visualize the attention maps of the first 4 images.
    """
    model.eval()
...
@torch.no_grad()
def visualize_attention_fashion_mnist(model, output=None, device="cuda"):
    """
    Visualize the attention maps of the first 4 images.
    """
    model.eval()
